# MODIFICACIÓN PARA AGREGAR FLECHA DE REGRESO EN PLAYLISTS

# 1. MODIFICAR el MDTopAppBar en el KV de ScreenLibrary (reemplazar líneas 143-149)
...
<ScreenLibrary>:
    ...
    MDBoxLayout:
        ...
        MDTopAppBar:
            ...
            # NUEVO: left_action_items dinámicos para la flecha de regreso
            left_action_items: []  # Se llenará dinámicamente
            # Mover los botones derechos a una variable
...
# 2. AGREGAR estas funciones a tu main.py
...
# 3. MODIFICAR on_key para que también resetee el top bar
...
# 📱 Flujo con flecha visible:
# 1. Estás en "RECOMENDADOS PARA TI" (sin flecha)
# 2. Entras a "PLAYLIST: FAVORITOS" 
#    → Aparece flecha ← "FAVORITOS" en el top bar
# 3. Le das a la flecha ← 
#    → Vuelve a "RECOMENDADOS PARA TI" (sin flecha)

# 🎯 Ventajas:
# - Flecha siempre visible cuando no estás en recommendations
# - Título cambia para mostrar dónde estás
# - Click en flecha siempre vuelve a recommendations
# - Compatible con back button de Android
# - No se puede perder, siempre hay salida visible
